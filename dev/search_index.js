...

{
    ...
    "title": "Projections.jl",
    "category": "section",
    "text": "Projections.jl is a Julia package that collects commonly used projection operators. It is useful for optimization algorithms such as projected gradient descent.Given a point y in mathbbR^n and a set S subset mathbbR^n, the projection of y onto S is defined as   $     \\text{proj}S(y) = \\arg \\min{x \\in S} \\|x - y\\|2^2. $    If S is a closed convex set, then \\text{proj}S(y)$ is unique."
},
...

{
    ...
    "title": "Basic usage",
    "category": "section",
    "text": "This package provides two functions for each set:project!(s, v, y)overwrites v by projection of y to set s and project(s, y)simply returns projection of y to set s."
},
...

{
    ...
    "title": "Box",
    "category": "section",
    "text": "Projection of y onto a closed box S = a_1 b_1 times cdots times a_n b_n is   $       \\text{proj}S(y)i = \\begin{cases}       ai & yi < ai \\       yi & yi \\in [ai, bi] \\       bi & yi > bi       \\end{cases}.   $    Computational cost is O(n).y = [-2.5, -1.5, -0.5, 0.0, 0.5, 1.5, 2.5]\na = fill(-1.0, 7) # vector of all -1\nb = fill( 1.0, 7) # vector of all  1\nproject(Box(a, b), y)7-element Array{Float64,1}:\n -1.0\n -1.0\n -0.5\n  0.0\n  0.5\n  1.0\n  1.0"
},

{
    ...
    "title": "Simplex",
    "category": "section",
    "text": "There is no analytical solution for the projection of a point y onto the simplex S = x in mathbbR^n x_i ge 0 sum_i x_i = r. An O(n log n) algorithm given by Duchi, Shalev-Shwartz, Singer, and Chandra is implemented.y = [1., 1., 1.]\n# canonical probability simplex\nproject(Simplex(), y) 3-element Array{Float64,1}:\n 0.33333333333333337\n 0.33333333333333337\n 0.33333333333333337project(Simplex(2), y) 3-element Array{Float64,1}:\n 0.6666666666666667\n 0.6666666666666667\n 0.6666666666666667"
},
